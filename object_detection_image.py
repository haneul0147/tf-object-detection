...
from plot_object_detection_saved_model import PATH_TO_LABELS
...
print()
print(detection_model.signatures['serving_default'].output_dtype)
print()
print(detection_model.signatures['serving_default'].output_shapes)

# 우리가 가지고 있는 이미지경로에서 이미지를 가져오는 코드
